...
^$scylla_client_path -e r#'create keyspace cache with replication = { 'class': 'NetworkTopologyStrategy', 'replication_factor': 1 };'#
^$scylla_client_path -k cache -f packages/cache/src/scylla.cql
