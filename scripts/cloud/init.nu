...
^$scylla_client_path -e r#'create keyspace objects with replication = { 'class': 'NetworkTopologyStrategy', 'replication_factor': 1 };'#
^$scylla_client_path -k objects -f packages/stores/log/src/scylla.cql
^$scylla_client_path -k objects -f packages/stores/object/src/scylla.cql
