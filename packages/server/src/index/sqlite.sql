...
create table objects (
	...
	count integer,
	depth integer,
	self_solvable integer not null,
	self_solved integer not null,
	solvable integer,
	solved integer,
	transaction_id integer not null,
	reference_count integer,
...
create table processes (
	...
	children_commands_complete integer not null default 0,
	children_commands_count integer,
	children_commands_depth integer,
	children_commands_weight integer,
	children_outputs_complete integer not null default 0,
	children_outputs_count integer,
	children_outputs_depth integer,
	children_outputs_weight integer,
	command_complete integer not null default 0,
	command_count integer,
	command_depth integer,
	command_weight integer,
