		...
		let update_statement = indoc!(
			"
				...
				set
					...
					children_commands_complete = children_commands_complete or ?8,
					children_commands_count = coalesce(children_commands_count, ?9),
					children_commands_depth = coalesce(children_commands_depth, ?10),
					children_commands_weight = coalesce(children_commands_weight, ?11),
					...
					children_outputs_complete = children_outputs_complete or ?16,
					children_outputs_count = coalesce(children_outputs_count, ?17),
					children_outputs_depth = coalesce(children_outputs_depth, ?18),
					children_outputs_weight = coalesce(children_outputs_weight, ?19),
					touched_at = ?20
				where id = ?1;
			"
		);
