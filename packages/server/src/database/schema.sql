...
create index process_token_count on processes (token_count) where token_count = 0 and status != 'finished';
...
create index process_token_index on process_tokens (token);

create trigger process_token_count_on_insert
