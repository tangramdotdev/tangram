...
impl Session {
	pub(crate) async fn try_get_namespace_turso(
		&self,
		...
		let output = Self::try_get_namespace_turso_with_transaction(&transaction, namespace)
			.await?
	...
	pub(crate) async fn try_get_namespace_turso_with_transaction(
