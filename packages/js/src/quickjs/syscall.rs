...
pub fn syscall<'js>(
	...
	let func: qjs::Function = match name.as_str() {
		...
		"host_stdin_close" => qjs::Function::new(ctx.clone(), Async(self::host::stdin_close)),
		"host_stdin_open" => qjs::Function::new(ctx.clone(), Async(self::host::stdin_open)),
		"host_stdin_read" => qjs::Function::new(ctx.clone(), Async(self::host::stdin_read)),
