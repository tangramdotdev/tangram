...
pub fn syscall<'s>(
	...
	let result = match name.as_str() {
		...
		"host_stop_close" => async_(scope, &args, self::host::stop_close),
		"host_stop_open" => async_(scope, &args, self::host::stop_open),
		"host_stop_stop" => async_(scope, &args, self::host::stop_stop),
