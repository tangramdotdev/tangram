...
pub fn syscall<'s>(
	...
	let result = match name.as_str() {
		...
		"host_stdin_close" => async_(scope, &args, self::host::stdin_close),
		"host_stdin_open" => async_(scope, &args, self::host::stdin_open),
		"host_stdin_read" => async_(scope, &args, self::host::stdin_read),
