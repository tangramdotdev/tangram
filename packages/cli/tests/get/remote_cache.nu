...
assert (($group | get --optional tokens.local) != null) "remote get should return a token"
...
assert (($cached | get --optional tokens.local) != null) "cached get should preserve the token"
