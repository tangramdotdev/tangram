...
let query = { availability: true, location: 'remote(a)', metadata: true, 'tokens[local][authorization][0]': $local.tokens.local.authorization.0, 'tokens[remote][authorization][0]': $owned.tokens.local.authorization.0 } | url build-query
...
let query = { location: 'remote(missing)', metadata: true, 'tokens[local][authorization][0]': $local.tokens.local.authorization.0, 'tokens[remote][authorization][0]': $owned.tokens.local.authorization.0 } | url build-query
