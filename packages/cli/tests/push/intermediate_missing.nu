...
# Pushing a directory whose intermediate file is missing locally but present on the remote completes and yields matching objects and metadata, under both eager and lazy push.
