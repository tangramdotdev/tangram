...
let local_main_tag = tg tag get test-main/1.0.0 | from json | get target.id
let local_single_tag = tg tag get test-single-file/1.0.0 | from json | get target.id
let local_multi_tag = tg tag get test-multi-file/1.0.0 | from json | get target.id
...
let remote_single_tag = tg --url $remote.url tag get test-single-file/1.0.0 | from json | get target.id
let remote_multi_tag = tg --url $remote.url tag get test-multi-file/1.0.0 | from json | get target.id
