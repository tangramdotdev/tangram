...
let remote_main_tag = tg --url $remote.url tag get test-main/1.0.0 | from json | get target.id
let remote_dep_tag = tg --url $remote.url tag get test-dep/1.0.0 | from json | get target.id
let remote_transitive_tag = tg --url $remote.url tag get test-transitive/1.0.0 | from json | get target.id
