...
let local_a_tag = tg tag get test-a/1.0.0 | from json | get target.id
let local_b_tag = tg tag get test-b/1.0.0 | from json | get target.id
...
let remote_a_tag = tg --url $remote.url tag get test-a/1.0.0 | from json | get target.id
let remote_b_tag = tg --url $remote.url tag get test-b/1.0.0 | from json | get target.id
