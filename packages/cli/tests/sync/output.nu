...
# Setup returns a reusable sync token before transfer messages arrive and rejects forged tokens.
...
success $output 'the sync output should precede the transfer and preserve a supplied token'
