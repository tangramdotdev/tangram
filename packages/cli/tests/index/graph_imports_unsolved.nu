...
tg --url $remote.url tag -p c/1.0.0 $c1_id
tg --url $remote.url tag -p c/2.0.0 $c2_id
tg --url $remote.url tag -p a/1.0.0 $a_id
tg --url $remote.url tag -p b/1.0.0 $b_id
tg --url $remote.url tag -p unsolved/1.0.0 $unsolved_id
