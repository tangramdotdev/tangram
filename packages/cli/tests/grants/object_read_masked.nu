...
assert ($denied.stderr | str contains "failed to load the object") "the private file should be masked as not found."
assert (not ($denied.stderr | str contains "unauthorized")) "the masked read should not reveal that the file exists."
