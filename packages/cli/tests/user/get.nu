...
assert (($by_id | get --optional token) != null) "getting a user by id should return a token"
...
assert (($by_specifier | get --optional token) != null) "getting a user by specifier should return a token"
