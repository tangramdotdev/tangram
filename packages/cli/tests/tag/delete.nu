...
# Delete a leaf tag.
let output = run tg tag delete "test/1.0.0" | from json
...
run tg tag delete "test/foo/bar"
...
run tg tag delete "test/foo/baz"

# Now we can delete empty branch.
let output = run tg tag delete "test/foo" | from json
