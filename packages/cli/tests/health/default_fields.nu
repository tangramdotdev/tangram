...
assert equal $health.processes.capacity.total.memory ($health.processes.capacity.total.cpus * 1_073_741_824) "the runner should have 1 GiB of memory per CPU by default"
