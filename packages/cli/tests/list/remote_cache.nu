...
assert (($initial.0 | get --optional tokens.local) != null) "remote list should return a token"
...
assert (($cached.0 | get --optional tokens.local) != null) "the cached response should preserve the token"
