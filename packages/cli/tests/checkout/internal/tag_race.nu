...
let indexer_watch = (
	tg checkpoint watch indexer.database_index_queue.named_node
	| from json
	| get watch
)
...
tg checkpoint wait indexer.database_index_queue.named_node $indexer_watch 0 | ignore
tg checkpoint continue indexer.database_index_queue.named_node $indexer_watch 0
tg checkpoint unwatch indexer.database_index_queue.named_node $indexer_watch
