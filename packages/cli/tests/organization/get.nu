...
assert (($by_id | get --optional token) != null) "getting an organization by id should return a token"
...
assert (($by_specifier | get --optional token) != null) "getting an organization by specifier should return a token"
