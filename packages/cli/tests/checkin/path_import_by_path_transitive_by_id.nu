...
snapshot $object '
	tg.directory({
	  "tangram.ts": tg.file({
	    "contents": tg.blob("import * as inner from \"dir_01yhv45cdwr5vttjv9yj4d1mky56a0z52kyz5mkxvc0nvmxznkemw0\";"),
	    "dependencies": {
	      "dir_01yhv45cdwr5vttjv9yj4d1mky56a0z52kyz5mkxvc0nvmxznkemw0": {
	        "item": tg.directory({
	          "tangram.ts": tg.file({
