...
snapshot $object '
	tg.directory({
	  "tangram.ts": tg.file({
	    "contents": tg.blob("import * as inner from \"dir_01ca6c1b6q2xpzdp38xwcpk8mh6qzse78gqfycjj8ve43fq1ksw7mg\";"),
	    "dependencies": {
	      "dir_01ca6c1b6q2xpzdp38xwcpk8mh6qzse78gqfycjj8ve43fq1ksw7mg": {
	        "node": tg.directory({
	          "tangram.ts": tg.file({
