...
# The process can read its executable node; the untrusted runner must prove access to its contents separately.
let watch = (
...
success $output "Bob's process should re-pull artifact A's contents from an untrusted remote"
